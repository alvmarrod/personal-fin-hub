...
const cashFlowData = {
  ...
  lines: [
    { period: '2025-01', type: 'INCOME', currency: 'EUR', total_value: 3500.0, count: 2 },
    ...
    { period: '2025-02', type: 'INCOME', currency: 'EUR', total_value: 3500.0, count: 1 },
    { period: '2025-02', type: 'INCOME', currency: 'USD', total_value: 124.5, count: 1 },
    ...
    { period: '2025-03', type: 'INCOME', currency: 'EUR', total_value: 4000.0, count: 2 },
    ...
    { period: '2025-04', type: 'INCOME', currency: 'EUR', total_value: 3500.0, count: 1 },
    { period: '2025-04', type: 'INCOME', currency: 'EUR', total_value: 15.5, count: 1 },
    ...
    { period: '2025-05', type: 'INCOME', currency: 'EUR', total_value: 3500.0, count: 1 },
    { period: '2025-05', type: 'INCOME', currency: 'EUR', total_value: 210.0, count: 2 },
    ...
    { period: '2025-06', type: 'INCOME', currency: 'EUR', total_value: 5000.0, count: 1 },
    ...
    { period: '2025-07', type: 'INCOME', currency: 'EUR', total_value: 5518.18, count: 2 },
    { period: '2025-07', type: 'INCOME', currency: 'USD', total_value: 128.0, count: 1 },
    { period: '2025-07', type: 'INCOME', currency: 'EUR', total_value: 12.35, count: 1 },
