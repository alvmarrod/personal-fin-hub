...
- **Tests**: 49 new tests — 38 in `tests/test_api_resilience.py` (breaker state machine + `_request` integration + loop fail-fast), 3 health circuit tests, 6 holdings-metadata tests, 2 portfolio-assets propagation tests. Total suite now 932.
