...
class TestTransferService(unittest.TestCase):
    ...
    def test_create_transfer_no_fees(self):
        ...
        self.assertEqual(result.from_transaction.type.value, "TRANSFER_OUT")
        ...
        self.assertEqual(result.to_transaction.type.value, "TRANSFER_IN")
...
class TestTransferRoutes(unittest.TestCase):
    ...
    def test_create_transfer_no_fees(self):
        ...
        data = resp.json()
        self.assertEqual(data["from_transaction"]["type"], "TRANSFER_OUT")
        self.assertEqual(data["from_transaction"]["entity_id"], self.from_eid)
        self.assertEqual(data["to_transaction"]["type"], "TRANSFER_IN")
